...
function DecisionTreePredict() {
  const [formData, setFormData] = useState({
    ...
    heartRate: 75,
    glucose: 90,
    model_type: "decision_tree" // ✅ Automatically select Decision Tree model
  });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-900 text-white p-8">
      ...
      >
        {/* Left Side: Questions */}
        <div className="w-1/2">
          <h2 className="text-3xl font-bold text-center text-blue-400 mb-6">Decision Tree Model</h2>
...
export default DecisionTreePredict;
